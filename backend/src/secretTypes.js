...
export const SECRET_TYPES = [
  ...
  },
  {
    ...
    name: 'GitHub Token',
    risk: 'high',
    what: 'GitHub 리포지토리·계정에 접근하는 액세스 토큰(ghp_, gho_ 등).',
  ...
  },
  {
    ...
    risk: 'high',
    what: 'GitHub 세분화 개인 액세스 토큰(github_pat_).',
    impact: '지정된 리포지토리·권한 범위 내에서 무단 접근·변조가 가능하다.',
    fix: '토큰을 폐기하고 필요한 최소 범위로만 재발급한다.',
  },
  {
    id: 'slack_token',
    name: 'Slack Token',
    risk: 'high',
    what: 'Slack 워크스페이스/봇 API 토큰(xoxb-, xoxp- 등).',
    impact: '메시지 열람·전송, 채널 접근, 내부 정보 유출로 이어질 수 있다.',
    fix: '토큰을 폐기(rotate)하고 OAuth 범위를 최소화한다.',
  },
  {
    id: 'stripe_key',
    name: 'Stripe Secret Key',
    risk: 'critical',
    what: 'Stripe 결제 API 시크릿 키(sk_live_).',
    impact: '결제·환불 조작, 고객 결제 정보 접근 등 금전적 피해로 직결된다.',
    fix: '키를 즉시 roll 하고 서버에서만 사용한다. 공개 키(pk_)와 혼동하지 않는다.',
  },
  {
    id: 'openai_key',
    name: 'OpenAI API Key',
    risk: 'high',
    what: 'OpenAI API 호출에 사용되는 시크릿 키(sk-).',
    impact: '무단 호출로 인한 과금·할당량 소진이 발생할 수 있다.',
    fix: '키를 폐기하고 서버 환경변수로 옮긴 뒤 사용량 한도를 설정한다.',
  },
  {
    id: 'jwt',
    name: 'JSON Web Token',
